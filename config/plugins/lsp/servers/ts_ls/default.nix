      ...
      ''
        ...
        vim.api.nvim_create_user_command("PopulateQuickfixTS", function()
        	local command_output =
        		vim.fn.systemlist("${pkgs.nodejs_latest}/bin/npx tsc -b --pretty false || ${pkgs.typescript-go}/bin/tsc")
        	vim.fn.setqflist({}, "r")
        	local quickfix_list = {}
        ...
        vim.api.nvim_create_user_command("PopulateQuickfixESLint", function()
        	local command_output =
        		vim.fn.systemlist("${pkgs.nodejs_latest}/bin/npx eslint --report-unused-disable-directives --max-warnings 0 .")
        	vim.fn.setqflist({}, "r")
        ...
        vim.api.nvim_create_user_command("PopulateQuickfixVitest", function()
        	local command_output = vim.fn.systemlist("${pkgs.nodejs_latest}/bin/npx vitest run --silent --reporter json")
        	vim.fn.setqflist({}, "r")
